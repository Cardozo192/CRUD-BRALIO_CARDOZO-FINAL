...
public final class FragmentAddQuoteBinding implements ViewBinding {
  ...
  private FragmentAddQuoteBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnCancelAdd,
  ...
  public static FragmentAddQuoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddQuoteBinding((ConstraintLayout) rootView, btnCancelAdd, btnCreateQuote,
