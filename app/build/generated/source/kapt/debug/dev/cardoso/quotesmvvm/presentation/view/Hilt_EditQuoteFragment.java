 ...
 */
public abstract class Hilt_EditQuoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditQuoteFragment() {
    super();
  }

  Hilt_EditQuoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditQuoteFragment_GeneratedInjector) this.generatedComponent()).injectEditQuoteFragment(UnsafeCasts.<EditQuoteFragment>unsafeCast(this));
    }
  }
