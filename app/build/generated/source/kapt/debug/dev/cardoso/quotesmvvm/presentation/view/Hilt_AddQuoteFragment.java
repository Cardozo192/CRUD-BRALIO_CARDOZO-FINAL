 ...
 */
public abstract class Hilt_AddQuoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddQuoteFragment() {
    super();
  }

  Hilt_AddQuoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddQuoteFragment_GeneratedInjector) this.generatedComponent()).injectAddQuoteFragment(UnsafeCasts.<AddQuoteFragment>unsafeCast(this));
    }
  }
